...
exists purely so existing invocations keep working unchanged:
    ...
    python automation/verify_security.py

It delegates to `lunawave_framework.automation.verify_security` and sets
...
from lunawave_framework.automation.verify_security import main
