...
exists purely so existing invocations keep working unchanged:
    ...
    python automation/call_graph.py

It delegates to `lunawave_framework.automation.call_graph` and sets
...
from lunawave_framework.automation.call_graph import main
