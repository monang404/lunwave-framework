...
exists purely so existing invocations keep working unchanged:
    ...
    python automation/verify_docs.py

It delegates to `lunawave_framework.automation.verify_docs_cli` and sets
...
from lunawave_framework.automation.verify_docs_cli import main
