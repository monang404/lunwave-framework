...
exists purely so existing invocations keep working unchanged:
    ...
    python automation/find_silent_excepts.py

It delegates to `lunawave_framework.automation.find_silent_excepts` and sets
...
from lunawave_framework.automation.find_silent_excepts import main
