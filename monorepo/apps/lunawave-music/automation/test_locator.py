...
exists purely so existing invocations keep working unchanged:
    ...
    python automation/test_locator.py

It delegates to `lunawave_framework.automation.test_locator` and sets
...
from lunawave_framework.automation.test_locator import main
