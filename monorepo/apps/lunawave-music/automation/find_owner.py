...
exists purely so existing invocations keep working unchanged:
    ...
    python automation/find_owner.py

It delegates to `lunawave_framework.automation.find_owner` and sets
...
from lunawave_framework.automation.find_owner import main
